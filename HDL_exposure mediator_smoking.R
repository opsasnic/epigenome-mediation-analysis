...
= read.csv('/net/orion/skardia_lab/treehouse/science/projects/Health_Retirement_Study/Epigenetics/Stress/data/aim2analysis_final2.csv', header=T)
...
snpmod1 = function(out) {
  temp = na.omit(hrs[,c(out, 'PHDLD','cumbur6_zscore2', 'smoking', 'age', 'edu', 'gender', 'indicator2010', 'PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6', 'PC7', 'PC8', 'PC9', 'PC10')])
...
path = '/net/orion/skardia_lab/treehouse/science/projects/Health_Retirement_Study/Epigenetics/Stress/results/Aim2/ExposureMediator/HDL2/NewAdj/'
